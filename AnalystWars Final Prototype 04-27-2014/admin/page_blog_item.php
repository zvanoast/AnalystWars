...
<head>
<meta charset="utf-8"/>
<title>AnalystWars | Blog Post</title>
				...
				<div class="col-md-12 blog-page">
					<div class="row">
						<div class="col-md-9 article-block">
							<h3>Hello . This is the blog title..</h3>
							...
							<div class="media">
								...
								<div class="media-body">
									<h4 class="media-heading">Alex Fong
									<span>
										 5 hours ago /
										<a href="#">
											 Reply
									...
									<div class="media">
										...
										<div class="media-body">
											<h4 class="media-heading">Lorean chi
											<span>
												 17 hours ago /
												<a href="#">
													 Reply
									...
									<div class="media">
										...
										<div class="media-body">
											<h4 class="media-heading">Sam Hee
											<span>
												 2 days ago /
												<a href="#">
													 Reply
							...
							<div class="media">
								...
								<div class="media-body">
									<h4 class="media-heading">David Lee
									<span>
										 July 5,2013 /
										<a href="#">
											 Reply
						...
						<div class="col-md-3 blog-sidebar">
							...
							<ul class="list-inline sidebar-tags">
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Business
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Music
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Internet
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Money
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Google
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> TV Shows
									</a>
								</li>
								<li>
									<a href="#">
								...
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Math
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Photos
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Electronics
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Apple
									</a>
								</li>
								<li>
									<a href="#">
										<i class="fa fa-tags"></i> Canada
									</a>
								</li>
							</ul>
							<div class="space20">
							...
							<div class="blog-twitter">
								...
								<div class="blog-twitter-block">
									...
									<p>
										 social networking site for stock.
									</p>
									<a href="#">
										<em>http://analystwars.com</em>
									</a>
